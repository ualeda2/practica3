...
Los archivos JavaDoc que se obtienen tras la ejecución de Maven se guardan de forma predeterminada en la carpeta `target/site/apidocs`. Para ver la documentación, abre el archivo `index.html` de esa carpeta.
